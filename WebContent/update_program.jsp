		...
		<table class="table">
			...
			<tbody>
                <% for (Program proList : proLists) { %>
                    <form action="./UdateProg" method="post">
                        <tr>
                            <th scope="col"><input type="text" name="proName" value="<%= proList.getProgramName() %>" readonly></input></th>
                            <td scope="col"><textarea name="desc" id=""><%= proList.getDescription() %></textarea></td>
                            <td scope="col"><input type="text" name="appEle" value="<%= proList.getApplicantEligibility() %>"></input></td>
                            <td scope="col"><input type="number" name="durInMon" value="<%= proList.getDurationInMonths() %>"></input></td>
                            <td scope="col"><input type="text" name="degCert" value="<%= proList.getDegreeCertificateOffered() %>"></input></td>
                            <td scope="col"><textarea type="text" name="imgUrl"><%= proList.getImgUrl() %></textarea></td>
