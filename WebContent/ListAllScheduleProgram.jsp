...
<title>All Scheduled Programs</title>
</head>
<body class="container">
    ...
    <div class="form-group mt-2">
        ...
        <a href="./scheduleProgram"><button class="btn btn-success">Add more</button></a>
    </div>
	<%
    ...
    <div class="container mt-2">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <th scope="col"><%= proList.getScheduledProgramId() %></th>
                    <td scope="col"><%= proList.getProgramName() %></td>
                    <td scope="col"><%= proList.getLocation() %></td>
                    <td scope="col"><%= proList.getStartDate() %></td>
                    <td scope="col"><%= proList.getEndDate() %></td>
                    <td scope="col"><%= proList.getSessionsPerWeek() %></td>
                </tr>
                <% }%>
            </tbody>
        </table>
