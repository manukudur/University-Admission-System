...
<body class="container">
    ...
    <div class="container card  mt-2">
        <div class="containercard-body">
            <form method="POST" action="./CheckApp">
                <div class="form-group row mt-4">
                    <label for="appId" class="col-sm-2 col-form-label">Enter Application Id</label>
                    <div class="col-sm-10">
                        <input type="text" name="appId" class="form-control" id="appId" required>
                    </div>
                </div>
                <div class="form-group row mt-4">
