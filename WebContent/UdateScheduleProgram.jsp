...
<title>Update Scheduled Programs</title>
</head>
<body>
	<%
    ...
    <div class="mt-2">
        <table class="table">
            ...
            <tbody>
                ...
                <form action="./UdateScheProg" method="post">
                    <tr>
                        <th scope="col"><input type="text" name="proId" value="<%= proList.getScheduledProgramId() %>" readonly></input></th>
                        <td scope="col"><input type="text" name="proName" value="<%= proList.getProgramName() %>" readonly></input></td>
                        <td scope="col"><input type="text" name="loc" value="<%= proList.getLocation() %>"></input></td>
                        <td scope="col"><input type="date" name="sdate" value="<%= proList.getStartDate() %>"></input></td>
                        <td scope="col"><input type="date" name="edate" value="<%= proList.getEndDate() %>"></input></td>
                        <td scope="col"><input type="number" name="spw" value="<%= proList.getSessionsPerWeek() %>"></input></td>
